...
${GreenBG}░░░░░░░    ░░░░░░   ░░░░░  ░░  ░░  ░░░░░░ ░░░    ░░         ░░ ░░ ░░░    ░░░     ░░░░░░  ░░░    ${Font}
${Font}\n
Docker 镜像源配置助手,作者 2678885646@qq.com
\n"
...
MIRRORS=(https://hub.geekery.cn https://ghcr.geekery.cn https://quay.geekery.cn	https://gcr.geekery.cn)
...
configure_daemon_json() {
    if [ ! -f "$DAEMON_JSON_PATH" ]; then
        echo -e "${Warning} 没找到 ${DAEMON_JSON_PATH} 创建中..."
        mkdir -p /etc/docker/
