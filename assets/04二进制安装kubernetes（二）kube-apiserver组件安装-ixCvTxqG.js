...
<span class="line"><span># systemctl enable keepalived</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><p>检查VIP情况：</p><p>7-11是主，现在vip绑定在主上，正常：</p><p><img src="`+a+`" alt="img"></p><p>如果keepalived出现脑裂问题，两台上面都有vip，可以加入以下配置，将多播修改成单播：</p><p><img src="`+o+`" alt="img"></p><p>至此，apiserver部署完成，并且配置了负载高可用。下一章节部署kube-controller-manager。</p>`,59)]])}var u=t(c,[[`render`,l]]);export{s as _pageData,u as default};