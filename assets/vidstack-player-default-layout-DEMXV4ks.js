const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vidstack-BTigPj2h-BQH6ctK5.js","assets/app-huHx0yVU.js"])))=>i.map(i=>d[i]);
var vs=Object.defineProperty;var fs=Object.getPrototypeOf;var hs=Reflect.get;var pe=e=>{throw TypeError(e)};var $s=(e,t,s)=>t in e?vs(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var _=(e,t,s)=>$s(e,typeof t!="symbol"?t+"":t,s),Gt=(e,t,s)=>t.has(e)||pe("Cannot "+s);var v=(e,t,s)=>(Gt(e,t,"read from private field"),s?s.call(e):t.get(e)),b=(e,t,s)=>t.has(e)?pe("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),D=(e,t,s,n)=>(Gt(e,t,"write to private field"),n?n.call(e,s):t.set(e,s),s),h=(e,t,s)=>(Gt(e,t,"access private method"),s);var Lt=(e,t,s)=>hs(fs(e),s,t);import{aV as x,h as be,j as P,o as at,aU as ge,bW as bs,aw as C,g as R,aS as gs,au as ys,aP as xs,w,bX as ye,C as Ss,bY as xe,bZ as g,aO as Ts,q as Yt,bg as Se,ay as st,b_ as Te,aE as ws,b$ as ks,A as Cs,aR as we,c0 as bt,k as ot,c1 as As,s as Ds,af as Ms,c2 as Is,aI as Os,z as V,c3 as _s,aZ as Ps,_ as Gs,az as ke,l as Nt,b1 as Ls,c4 as Ns,c5 as Bs,c6 as Fs,br as Ce}from"./app-huHx0yVU.js";import{A as W,T as Vs,D as me,x as l,s as Rs,L as Ae}from"./vidstack-CwTj4H1w-BCQqYYxA.js";/**
 * @license
  ...
  `}function zn(){return a(()=>{const{live:e,duration:t}=g();return e()?Re():t()?l`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})}function je(){return a(()=>{const{live:e}=g();return e()?Re():Un()})}function Ye(){return a(()=>{const{textTracks:e}=C(),{title:t,started:s}=g(),n=w(null);return we(e,"chapters",n.set),n()&&(s()||!t())?Ze():l`<media-title class="vds-chapter-title"></media-title>`})}function Ze(){return l`<media-chapter-title class="vds-chapter-title"></media-chapter-title>`}class Xe extends Xs{async loadIcons(){const t=(await Gs(async()=>{const{icons:n}=await import("./vidstack-BTigPj2h-BQH6ctK5.js");return{icons:n}},__vite__mapDeps([0,1]))).icons,s={};for(const n of Object.keys(t))s[n]=Ys({name:n,paths:t[n]});return s}}var F;let Hn=(F=class extends Ct{},_(F,"props",{...Lt(F,F,"props"),when:({viewType:t})=>t==="audio",smallWhen:({width:t})=>t<576}),F);function qn(){return[Jt(),ne(),l`
    ...
    `]}function jn(){return a(()=>{let e=w(void 0),t=w(!1),s=C(),{title:n,started:i,currentTime:o,ended:r}=g(),{translations:p}=u(),c=Ns(e),y=()=>i()||o()>0;const f=()=>{const S=r()?"Replay":y()?"Continue":"Play";return`${k(p,S)}: ${n()}`};P(()=>{var S;c()&&document.activeElement===document.body&&((S=s.player.el)==null||S.focus({preventScroll:!0}))});function m(){const S=e(),T=!!S&&!c()&&S.clientWidth<S.children[0].clientWidth;S&&Bs(S,"vds-marquee",T),t.set(T)}function $(){return l`
      ...
      `}return xe(e,m),n()?l`
        ...
        `:L()})}function Yn(){const e="top end";return[Ke({tooltip:"top",placement:e,portal:!0}),qe({tooltip:"top end",placement:e,portal:!0})]}var mt,Z,A,Je,ts,es,ss,ns,is;class Ht extends ke(Ae,Hn){constructor(){super(...arguments);b(this,A);b(this,mt);b(this,Z,w(!1))}onSetup(){this.forwardKeepAlive=!1,D(this,mt,C()),this.classList.add("vds-audio-layout"),h(this,A,es).call(this)}onConnect(){Be("audio",()=>this.isMatch),h(this,A,ts).call(this)}render(){return a(h(this,A,Je).bind(this))}}mt=new WeakMap,Z=new WeakMap,A=new WeakSet,Je=function(){return this.isMatch?qn():null},ts=function(){const{menuPortal:s}=u();P(()=>{if(!this.isMatch)return;const n=Ee(this,this.menuContainer,"vds-audio-layout",()=>this.isSmallLayout),i=n?[this,n]:[this];return(this.$props.customIcons()?new Pe(i):new Xe(i)).connect(),s.set(n),()=>{n.remove(),s.set(null)}})},es=function(){const{pointer:s}=v(this,mt).$state;P(()=>{s()==="coarse"&&P(h(this,A,ss).bind(this))})},ss=function(){if(!v(this,Z).call(this)){Nt(this,"pointerdown",h(this,A,ns).bind(this),{capture:!0});return}Nt(this,"pointerdown",s=>s.stopPropagation()),Nt(window,"pointerdown",h(this,A,is).bind(this))},ns=function(s){const{target:n}=s;Ls(n)&&n.closest(".vds-time-slider")&&(s.stopImmediatePropagation(),this.setAttribute("data-scrubbing",""),v(this,Z).set(!0))},is=function(){v(this,Z).set(!1),this.removeAttribute("data-scrubbing")},_(Ht,"tagName","media-audio-layout"),_(Ht,"attrs",{smallWhen:{converter(s){return s!=="never"&&!!s}}});/**
 * @license
