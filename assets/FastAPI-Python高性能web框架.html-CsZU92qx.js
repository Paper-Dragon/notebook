...
<span class="line"><span># people.friend()</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p><strong>pycharm安装pydantic插件</strong> <img src="`+i+`" alt=" image-20210202100216847 "></p><p><strong>校验失败的处理</strong></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span></span></span>
...
<span class="line"><span>localhost:8000/redoc</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h3 id="_3-2-fastapi的结构" tabindex="-1"><a class="header-anchor" href="#_3-2-fastapi的结构"><span>3.2 fastApi的结构</span></a></h3><p>首先创建一个文件包，用于存放各个app <img src="`+t+`" alt=" image-20210202145110225"></p><p>然后再<strong>chapter03.py</strong>中实现</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span></span></span>
...
<span class="line"><span>    finally:</span></span>
<span class="line"><span>        dep_c.endswith(dep_b)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h2 id="第6章-安全、认证和授权" tabindex="-1"><a class="header-anchor" href="#第6章-安全、认证和授权"><span>第6章：安全、认证和授权</span></a></h2><h3 id="_6-1-oauth2-密码模式和-fastapi-的-oauth2passwordbearer" tabindex="-1"><a class="header-anchor" href="#_6-1-oauth2-密码模式和-fastapi-的-oauth2passwordbearer"><span>6.1 OAuth2 密码模式和 FastAPI 的 OAuth2PasswordBearer</span></a></h3><p><img src="`+c+`" alt=" image-20210204152011882"></p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span></span></span>
