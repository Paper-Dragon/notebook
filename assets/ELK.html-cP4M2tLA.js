...
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">172.16.100.21</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> elk-node2</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>master-slave模式</p><figure><img src="`+p+`" alt="image-20211117083904657" tabindex="0" loading="lazy"><figcaption>image-20211117083904657</figcaption></figure><p>内存：大于2G</p><h2 id="elasticsearch" tabindex="-1"><a class="header-anchor" href="#elasticsearch"><span>Elasticsearch</span></a></h2><h3 id="基础环境安装-node1-node2同时进行" tabindex="-1"><a class="header-anchor" href="#基础环境安装-node1-node2同时进行"><span>基础环境安装 node1 node2同时进行</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" data-title="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">[root@node1 ~]# rpm --import https://packages.elastic.co/GPG-KEY-elasticsearch</span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">    }</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">[root@apache conf.d]# logstash -f apache_log.conf    </span><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;">#指定logstash的配置文件，根据apache_log.conf配置logstash（-f可以不重启加载）</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+o+'" alt="image-20211118000511866" tabindex="0" loading="lazy"><figcaption>image-20211118000511866</figcaption></figure><figure><img src="'+F+'" alt="image-20211118000504423" tabindex="0" loading="lazy"><figcaption>image-20211118000504423</figcaption></figure><figure><img src="'+u+'" alt="image-20211118000526400" tabindex="0" loading="lazy"><figcaption>image-20211118000526400</figcaption></figure><figure><img src="'+A+`" alt="image-20211118000641707" tabindex="0" loading="lazy"><figcaption>image-20211118000641707</figcaption></figure><h1 id="elasticsearch-redis" tabindex="-1"><a class="header-anchor" href="#elasticsearch-redis"><span>Elasticsearch + Redis</span></a></h1><p>首先从redis这台服务器下手吧</p><pre><code>yum install -y redis
