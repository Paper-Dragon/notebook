import{ah as i,ai as a,ar as n,am as l}from"./app-GrhoROuM.js";const e="/assets/1-n95HUpAx.png",h="/assets/image-20211110215222063-Dti_Neoa.png",t="/assets/2-CLd_h0Cs.png",p="/assets/3-DRRQvpyx.png",k={};function r(d,s){return l(),a("div",null,[...s[0]||(s[0]=[n(`<h1 id="tomcat构建企业级高负载服务器" tabindex="-1"><a class="header-anchor" href="#tomcat构建企业级高负载服务器"><span>Tomcat构建企业级高负载服务器</span></a></h1><h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言"><span>前言</span></a></h2><h3 id="什么是java虚拟机" tabindex="-1"><a class="header-anchor" href="#什么是java虚拟机"><span>什么是JAVA虚拟机</span></a></h3><pre><code>所谓虚拟机，就是一台虚拟的计算机。他是一款软件，用来执行一系列虚拟计算机指令。大体上，虚拟机可以分为系统虚拟机和程序虚拟机。大名鼎鼎的VisualBox、VMware就属于系统虚拟机。他们完全是对物理计算机的仿真。提供了一个可以运行完整操作系统的软件平台。
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#0184BC;--shiki-dark:#56B6C2;">source</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> /etc/profile</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在这里插入图片描述3.启动Tomcat</p><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">启动tomcat</span></span>
...
</code></pre><p>在这里插入图片描述在这里插入图片描述4.关于tomcat</p><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">[root@web ~]# cd /usr/local/tomcat/</span></span>
...
</code></pre><h2 id="jvm常用分析工具" tabindex="-1"><a class="header-anchor" href="#jvm常用分析工具"><span>JVM常用分析工具</span></a></h2><p><img src="`+h+`" alt="image-20211110215222063"></p><p>命令行工具</p><h3 id="jps" tabindex="-1"><a class="header-anchor" href="#jps"><span>jps</span></a></h3><p>Java虚拟机进程状态工具</p><pre><code>jps [options] [hostid]
  -q 显示进程ID
...
</code></pre><p>案例</p><p>jinfo 6564(这个命令jdk1.8报各种错，暂未解决)</p><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">➜</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">  ~</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> jinfo</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;"> 6564</span></span>
...
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">jvm_args:</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;"> -javaagent:/Applications/IntelliJ</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> IDEA.app/Contents/lib/idea_rt.jar=49825:/Applications/IntelliJ</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> IDEA.app/Contents/bin</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;"> -Dfile.encoding=UTF-8</span></span>
...
Server is ready.
	...
	-m 打印Java和C++栈信息
	-l 额外打印关于锁的信息
</code></pre><p>案例</p><p>jstack -l 7588</p><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">➜</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">  ~</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> jstack</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;"> -l</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;"> 7588</span></span>
...
<span class="line"><span style="--shiki-light:#0184BC;--shiki-dark:#56B6C2;">...</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">&quot;VM Thread&quot;</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> os_prio=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">31</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> cpu=150.43ms</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> elapsed=2575.96s</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> tid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x00007fb214002800</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> nid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x4d03</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> runnable</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">&quot;GC Thread#0&quot;</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> os_prio=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">31</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> cpu=12.00ms</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> elapsed=2575.99s</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> tid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x00007fb215005000</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> nid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x2d03</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> runnable</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">&quot;GC Thread#1&quot;</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> os_prio=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">31</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> cpu=6.44ms</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> elapsed=2425.77s</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> tid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x00007fb215896000</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> nid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x4207</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> runnable</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">&quot;GC Thread#2&quot;</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> os_prio=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">31</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> cpu=8.37ms</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> elapsed=2425.77s</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> tid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x00007fb214075000</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> nid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x5f03</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> runnable</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">&quot;G1 Main Marker&quot;</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> os_prio=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">31</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> cpu=0.91ms</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> elapsed=2575.99s</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> tid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x00007fb214022800</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> nid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x5203</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> runnable</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">&quot;G1 Conc#0&quot;</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> os_prio=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">31</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> cpu=0.04ms</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> elapsed=2575.99s</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> tid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x00007fb215005800</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> nid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x5003</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> runnable</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">&quot;G1 Refine#0&quot;</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> os_prio=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">31</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> cpu=0.71ms</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> elapsed=2575.99s</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> tid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x00007fb215836800</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> nid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x3103</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> runnable</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">&quot;G1 Young RemSet Sampling&quot;</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> os_prio=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">31</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> cpu=386.00ms</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> elapsed=2575.99s</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> tid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x00007fb214041800</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> nid=</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66;">0x3203</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> runnable</span></span>
...
</code></pre><h2 id="jvm运维使用监控工具" tabindex="-1"><a class="header-anchor" href="#jvm运维使用监控工具"><span>JVM运维使用监控工具</span></a></h2><h3 id="visual-vm" tabindex="-1"><a class="header-anchor" href="#visual-vm"><span>Visual VM</span></a></h3><p>Visual VM是一款All-in-One的Java分析工具，堆栈信息、线程信息等都可以分析，而且还支持装插件。但jdk1.9之后默认JDK不再支持，可以通过 <a href="https://visualvm.github.io/download.html" target="_blank" rel="noopener noreferrer">https://visualvm.github.io/download.html</a> 这里下载</p><p>在1.8环境下执行</p><p>~ jvisualvm</p><p><img src="`+p+'" alt="在这里插入图片描述"></p>',126)])])}const g=i(k,[["render",r]]),o=JSON.parse('{"path":"/note-book/Tomcat/Tomcat%E6%9E%84%E5%BB%BA%E4%BC%81%E4%B8%9A%E7%BA%A7%E9%AB%98%E8%B4%9F%E8%BD%BD%E6%9C%8D%E5%8A%A1%E5%99%A8.html","title":"Tomcat构建企业级高负载服务器","lang":"zh-CN","frontmatter":{"description":"Tomcat构建企业级高负载服务器 前言 什么是JAVA虚拟机 JAVA 如何做到跨平台 img Tomcat部署 官网地址 部署 一、Tomcat Http Server 环境 部署JAVA环境 提示 建议卸载默认安装openjdk软件 ①解压安装包 tar xf jdk-8u151-linux-x64.tar.gz -C /usr/local ②多...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Tomcat构建企业级高负载服务器\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2025-09-14T02:56:50.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Paper-Dragon\\",\\"url\\":\\"https://github.com/Paper-Dragon\\",\\"email\\":\\"2678885646@qq.com\\"}]}"],["meta",{"property":"og:url","content":"https://www.geekery.cn/note-book/Tomcat/Tomcat%E6%9E%84%E5%BB%BA%E4%BC%81%E4%B8%9A%E7%BA%A7%E9%AB%98%E8%B4%9F%E8%BD%BD%E6%9C%8D%E5%8A%A1%E5%99%A8.html"}],["meta",{"property":"og:site_name","content":"运维开发绿皮书"}],["meta",{"property":"og:title","content":"Tomcat构建企业级高负载服务器"}],["meta",{"property":"og:description","content":"Tomcat构建企业级高负载服务器 前言 什么是JAVA虚拟机 JAVA 如何做到跨平台 img Tomcat部署 官网地址 部署 一、Tomcat Http Server 环境 部署JAVA环境 提示 建议卸载默认安装openjdk软件 ①解压安装包 tar xf jdk-8u151-linux-x64.tar.gz -C /usr/local ②多..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-09-14T02:56:50.000Z"}],["meta",{"property":"article:modified_time","content":"2025-09-14T02:56:50.000Z"}]]},"git":{"createdTime":1691939318000,"updatedTime":1757818610000,"contributors":[{"name":"Paper-Dragon","username":"Paper-Dragon","email":"2678885646@qq.com","commits":3,"url":"https://github.com/Paper-Dragon"},{"name":"PaperDragon-SH","username":"PaperDragon-SH","email":"2678885646@qq.com","commits":1,"url":"https://github.com/PaperDragon-SH"}],"changelog":[{"hash":"608627034a98fa57e3d2f98dd7cb92b89d7c386c","time":1757818610000,"email":"2678885646@qq.com","author":"Paper-Dragon","message":"使用pretter进行语法重写"},{"hash":"acc20ecd1bcdb70acdb85ab952a0db582179691b","time":1744337611000,"email":"2678885646@qq.com","author":"Paper-Dragon","message":"Firefox密码提取"},{"hash":"9666a99af8ababd57058f589d56d11872bf3e98c","time":1710838269000,"email":"2678885646@qq.com","author":"PaperDragon-SH","message":"Tomcat格式化标题"},{"hash":"392a519398b2e846f316619fbe831e100164de7c","time":1691939318000,"email":"2678885646@qq.com","author":"Paper-Dragon","message":"Create The Worid!"}]},"readingTime":{"minutes":12.3,"words":3689},"filePathRelative":"note-book/Tomcat/Tomcat构建企业级高负载服务器.md","excerpt":"\\n<h2>前言</h2>\\n<h3>什么是JAVA虚拟机</h3>\\n<pre><code>所谓虚拟机，就是一台虚拟的计算机。他是一款软件，用来执行一系列虚拟计算机指令。大体上，虚拟机可以分为系统虚拟机和程序虚拟机。大名鼎鼎的VisualBox、VMware就属于系统虚拟机。他们完全是对物理计算机的仿真。提供了一个可以运行完整操作系统的软件平台。\\n程序虚拟机的典型代表就是Java虚拟机，它专门为执行单个计算机程序而设计，在Java虚拟机中执行的指令我们称为Java字节码指令。无论是系统虚拟机还是程序虚拟机，在上面运行的软件都呗限制于虚拟机提供的资源中。\\n</code></pre>\\n<h3>JAVA 如何做到跨平台</h3>","autoDesc":true}');export{g as comp,o as data};
