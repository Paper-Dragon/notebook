import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{aj as a,ao as i,am as t}from"./app-C1lz6nkA.js";const l="/assets/20191031161908405-16919219329121-D44-kTRO.png",o="/assets/watermark_type_ZmFuZ3poZW5naGVpdGk_shadow_10_text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl8zODgxNTk5OA___size_16_color_FFFFFF_t_70-16919219356843-Csm-zIe5.png",r={};function s(p,n){return t(),a("div",null,n[0]||(n[0]=[i('<h1 id="c语言volatile关键字详解" tabindex="-1"><a class="header-anchor" href="#c语言volatile关键字详解"><span>C语言volatile关键字详解</span></a></h1><h2 id="_1-volatile和什么有关" tabindex="-1"><a class="header-anchor" href="#_1-volatile和什么有关"><span>1.volatile和什么有关</span></a></h2><p>百度翻译是这样子翻译volatile的：</p><figure><img src="'+l+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>volatile属于C语言的关键字，《C Primer Plus》 是这样解释关键字的：关键字是C语言的词汇，由于编译器不具备真正的智能，所以你必须用编译器能理解的术语表示你的意图。开发者告诉编译器该变量是易变的，无非就是希望编译器去注意该变量的状态，时刻注意该变量是易变的，每次读取该变量的值都重新从内存中读取。（ahhhh，是不是一脸蒙蔽，举个例子吧）</p><pre><code>int i = 10;
int main(void){
